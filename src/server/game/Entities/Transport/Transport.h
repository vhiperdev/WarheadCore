...
class AC_GAME_API Transport : public GameObject, public TransportBase
{
public:
...
class AC_GAME_API MotionTransport : public Transport
{
...
class AC_GAME_API StaticTransport : public Transport
{
public:
    StaticTransport();
    ~StaticTransport();
