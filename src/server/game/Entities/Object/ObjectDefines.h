...
AC_GAME_API inline uint64 MAKE_PAIR64(uint32 l, uint32 h);
AC_GAME_API inline uint32 PAIR64_HIPART(uint64 x);
AC_GAME_API inline uint32 PAIR64_LOPART(uint64 x);
AC_GAME_API inline uint16 MAKE_PAIR16(uint8 l, uint8 h);
AC_GAME_API inline uint32 MAKE_PAIR32(uint16 l, uint16 h);
AC_GAME_API inline uint16 PAIR32_HIPART(uint32 x);
AC_GAME_API inline uint16 PAIR32_LOPART(uint32 x);

AC_GAME_API inline bool IS_EMPTY_GUID(uint64 guid);
AC_GAME_API inline bool IS_CREATURE_GUID(uint64 guid);
AC_GAME_API inline bool IS_PET_GUID(uint64 guid);
AC_GAME_API inline bool IS_VEHICLE_GUID(uint64 guid);
AC_GAME_API inline bool IS_CRE_OR_VEH_GUID(uint64 guid);
AC_GAME_API inline bool IS_CRE_OR_VEH_OR_PET_GUID(uint64 guid);
AC_GAME_API inline bool IS_PLAYER_GUID(uint64 guid);
AC_GAME_API inline bool IS_UNIT_GUID(uint64 guid);
AC_GAME_API inline bool IS_ITEM_GUID(uint64 guid);
AC_GAME_API inline bool IS_GAMEOBJECT_GUID(uint64 guid);
AC_GAME_API inline bool IS_DYNAMICOBJECT_GUID(uint64 guid);
AC_GAME_API inline bool IS_CORPSE_GUID(uint64 guid);
AC_GAME_API inline bool IS_TRANSPORT_GUID(uint64 guid);
AC_GAME_API inline bool IS_MO_TRANSPORT_GUID(uint64 guid);
AC_GAME_API inline bool IS_GROUP_GUID(uint64 guid);

// l - OBJECT_FIELD_GUID
// e - OBJECT_FIELD_ENTRY for GO (except GAMEOBJECT_TYPE_MO_TRANSPORT) and creatures or UNIT_FIELD_PETNUMBER for pets
// h - OBJECT_FIELD_GUID + 1
AC_GAME_API inline uint64 MAKE_NEW_GUID(uint32 l, uint32 e, uint32 h);

//#define GUID_HIPART(x)   (uint32)((uint64(x) >> 52)) & 0x0000FFFF)
AC_GAME_API inline uint32 GUID_HIPART(uint64 guid);
AC_GAME_API inline uint32 GUID_ENPART(uint64 x);
AC_GAME_API inline uint32 GUID_LOPART(uint64 x);

AC_GAME_API inline bool IsGuidHaveEnPart(uint64 guid);
AC_GAME_API inline char const* GetLogNameForGuid(uint64 guid);
