...
AC_GAME_API ByteBuffer& operator<<(ByteBuffer& buf, Position::PositionXYStreamer const& streamer);
AC_GAME_API ByteBuffer& operator >> (ByteBuffer& buf, Position::PositionXYStreamer const& streamer);
AC_GAME_API ByteBuffer& operator<<(ByteBuffer& buf, Position::PositionXYZStreamer const& streamer);
AC_GAME_API ByteBuffer& operator >> (ByteBuffer& buf, Position::PositionXYZStreamer const& streamer);
AC_GAME_API ByteBuffer& operator<<(ByteBuffer& buf, Position::PositionXYZOStreamer const& streamer);
AC_GAME_API ByteBuffer& operator >> (ByteBuffer& buf, Position::PositionXYZOStreamer const& streamer);
