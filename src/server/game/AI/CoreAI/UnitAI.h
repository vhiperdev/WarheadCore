...
struct AC_GAME_API DefaultTargetSelector
{
    const Unit* me;
    float m_dist;
    bool m_playerOnly;
...
struct AC_GAME_API SpellTargetSelector
{
    public:
...
struct AC_GAME_API NonTankTargetSelector
{
    public:
...
struct AC_GAME_API PowerUsersSelector
{
    Unit const* _me;
    Powers const _power;
    float const _dist;
...
struct AC_GAME_API FarthestTargetSelector
{
