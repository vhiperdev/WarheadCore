...
struct WH_GAME_API AccountData
{
...
class WH_GAME_API PacketFilter
{
public:
...
class WH_GAME_API WorldSessionFilter : public PacketFilter
{
public:
...
class WH_GAME_API CharacterCreateInfo
{
