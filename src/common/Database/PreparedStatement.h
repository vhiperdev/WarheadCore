...
struct AC_COMMON_API PreparedStatementData
{
...
class AC_COMMON_API PreparedStatement
{
...
//- is executed.
class AC_COMMON_API MySQLPreparedStatement
{
    friend class MySQLConnection;
...
class AC_COMMON_API PreparedStatementTask : public SQLOperation
{
    public:
