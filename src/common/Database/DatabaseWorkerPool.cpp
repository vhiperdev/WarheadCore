...
template class AC_COMMON_API DatabaseWorkerPool<LoginDatabaseConnection>;
template class AC_COMMON_API DatabaseWorkerPool<WorldDatabaseConnection>;
template class AC_COMMON_API DatabaseWorkerPool<CharacterDatabaseConnection>;
